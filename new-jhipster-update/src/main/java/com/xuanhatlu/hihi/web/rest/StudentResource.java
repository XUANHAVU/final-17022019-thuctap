    ...
    public ResponseEntity<String> saveUserDataAndFile(
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                studentDTO.setAgeStudent(currentRow.getCell(0).getStringCellValue());
                studentDTO.setNameStudent(String.format(formatter.formatCellValue(currentRow.getCell(1))));
                studentDTO.setAddress(String.format(formatter.formatCellValue(currentRow.getCell(2))));
                studentDTO.setPhone(String.format(formatter.formatCellValue(currentRow.getCell(3))));
                studentDTO.setEmail(String.format(formatter.formatCellValue(currentRow.getCell(4))));
                studentDTO.setLopId(Long.parseLong(formatter.formatCellValue(currentRow.getCell(5))));
